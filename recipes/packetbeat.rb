...
node.default['formatron_packetbeat']['logstash']['host'] = "#{logstash_config['sub_domain']}.#{hosted_zone_name}"
node.default['formatron_packetbeat']['logstash']['port'] = logstash_config['beats_port']
